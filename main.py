...
def ventana_principal():
    ...
    funciones = [ Funcion(sala1,"Harry Potter el mejor","14:00",True,"Lab2/images/f1.png"),
                  Funcion(sala1,"Shrek","17:00",True,"Lab2/images/f2.png"),
                  Funcion(sala2,"Avatar: El Camino del Agua","18:00",True,"Lab2/images/f3.png"),
                  Funcion(sala2, "Doctor Strange en el Multiverso de la Locura", "14:00", True,"Lab2/images/f4.png"),
                  Funcion(sala3,"Barbie","13:30", True,"Lab2/images/f5.png"),
                  Funcion(sala3,"Spider-Man: No Way Home","16:30", True,"Lab2/images/f6.png"),
